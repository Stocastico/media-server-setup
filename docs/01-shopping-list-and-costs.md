...
Prices below are indicative (Spain, September 2026, VAT included) and move
fast — SSD/RAM prices were rising sharply through 2025–26 due to a NAND/DRAM
shortage. Always check current prices (e.g. on idealo.es, or your local
equivalent) before buying; treat the numbers here as a starting budget, not
a quote.
